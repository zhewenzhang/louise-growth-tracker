...
// SVG icon components to replace emoji in navigation and UI
const Icons = {
  home: (props) => (
  ...
  ruler: (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M21.3 15.5a4 4 0 0 0-2.8-1.2 4 4 0 0 0-2.8 1.2l-1.4 1.4a4 4 0 0 1-5.6 0l-4.2-4.2a4 4 0 0 1 0-5.6l1.4-1.4a4 4 0 0 0 1.2-2.8 4 4 0 0 0-1.2-2.8" />
      <path d="M2 2l20 20" />
    </svg>
  ),
  head: (props) => (
